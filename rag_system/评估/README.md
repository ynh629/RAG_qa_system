...
# 自定义参数
python 评估/generate_qa_pairs.py --per-chunk 5 --start 0 --end 8
```
...
```bash
# 1. 导出 CSV
python 评估/review_qa_pairs.py --export-csv

# 2. Excel 打开 data/qa_pairs_review.csv 增删改后保存

# 3. 导入生成最终数据集
python 评估/review_qa_pairs.py --import-csv
```
