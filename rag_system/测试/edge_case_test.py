...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "混合检索"))
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "文本解析"))

from 系统日志.config import get_logger
from 异常处理.exceptions import DocumentError, IndexError_
...
def test_token_budget():
    ...
    print("\n[测试11] token 估算函数")
    from qa_system import _estimate_tokens
